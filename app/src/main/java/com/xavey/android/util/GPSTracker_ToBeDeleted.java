...
public class GPSTracker_ToBeDeleted extends Service implements LocationListener {
	...
	public GPSTracker_ToBeDeleted(Context context) {
		this.mContext = context;
		getLocation();
	}

    public GPSTracker_ToBeDeleted(Activity activity, Context mContext) {
	...
	public void stopUsingGPS(){
		if(locationManager != null){
			locationManager.removeUpdates(GPSTracker_ToBeDeleted.this);
		}		
	}
	...
	// following are new codes created at 18-9-2014
