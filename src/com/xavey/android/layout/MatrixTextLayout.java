...
public class MatrixTextLayout extends LinearLayout {
	...
	public MatrixTextLayout(Context context, AttributeSet attrs) {
		super(context, attrs);		
	}
	
	public MatrixTextLayout(Context context, AttributeSet attrs, int defStyle) {
		this(context, attrs);	
	}
